...
•	Intégration : Ce script est appelé en fin de <body> sur les pages connectées pour afficher l'heure à côté du titre du cours.
...
o	Section "Notifications" simulant des messages non lus.
o	Section "Annonces" 
